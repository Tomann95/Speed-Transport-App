...
{
    /// <inheritdoc />
    public partial class CMSAndInquiries : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    Description = table.Column<string>(type: "TEXT", nullable: false),
                    GraphicUrl = table.Column<string>(type: "TEXT", nullable: false),
                    CargoCapacityKg = table.Column<double>(type: "REAL", nullable: false),
                    ...
                    PricePerKm = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedVehicleId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransportRequests_Vehicles_SelectedVehicleId",
                        column: x => x.SelectedVehicleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportRequests_SelectedVehicleId",
                table: "TransportRequests",
                column: "SelectedVehicleId");
        }
